...
- Put product, skill, command, role, mode, runtime, and gate behavior in the relevant `docs/**` file or future `skills/poison/**` files.
...
rg -n "[ \t]+$" WORKFLOW.md poison_execution_plan_zh.md docs AGENTS.md CLAUDE.md README.md CONTRIBUTING.md SECURITY.md CHANGELOG.md
```
